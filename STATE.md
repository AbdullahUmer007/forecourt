...
**Last updated:** 2026-08-03 · by: Claude (M9–M11 build session)
**Current phase:** M0–M11 built. M12 (Deals & Evidence Ledger) next — needs FCA compliance sign-off.
...
| | |
|---|---|
| **Current module** | M12 — Deals & Evidence Ledger (`ready`, **needs FCA compliance sign-off**) |
| **Last shipped** | M11 (3 Aug 2026) — invoicing, the VAT stock book, payments and AML. 845 tests green including 170 isolation. |
| **Backlog complete** | 12 of 21 modules (57%) |
...
| | Now | 90-day target |
|---|---|---|
| Modules complete | 12 / 21 | 9 (M0–M8) — **ahead** |
| Tests passing | **845 green** across 25 files, including 170 isolation tests against real Postgres | — |
| Tables protected by RLS | 53 | every one |
