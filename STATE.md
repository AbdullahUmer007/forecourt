...
| | |
|---|---|
| **Current module** | Choose: **finish auth** (TOTP enrolment, password reset, per-IP rate limiting — the CRM cannot go near a dealer without them) · M16 Channel feeds · M18 Reporting. M15 Pricing intelligence is **blocked** on cap hpi valuations. |
| **Last shipped** | M14 prep pipeline, board included (4 Aug 2026). **1,168 tests green, 226 isolation, lint 0, typecheck 0, 72 tables protected.** |
| **Backlog complete** | 15 of 21 modules (71%) |
...
| | Now | 90-day target |
|---|---|---|
| Modules complete | 15 / 21 | 9 (M0–M8) — **well ahead** |
| Tests passing | **1,168 green** across 33 files, including 226 isolation tests against real Postgres | — |
| Tables protected by RLS | 72 | every one |
