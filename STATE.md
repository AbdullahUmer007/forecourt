...
| | |
|---|---|
| **Current module** | **`apps/crm` — the dealer application.** Authentication, the appraisal screens and the damage-mark write path all work. Next: TOTP enrolment and password reset to finish auth, the appraisal capture flow (reg lookup + derivative picker), then M14. |
| **Last shipped** | CRM authentication + the damage-mark mutation (3 Aug 2026). **1,084 tests green, 208 isolation, lint 0, typecheck 0.** |
| **Backlog complete** | 14 of 21 modules (67%) · first dealer-facing UI now exists |
...
| | Now | 90-day target |
|---|---|---|
| Modules complete | 14 / 21 | 9 (M0–M8) — **well ahead** |
| Tests passing | **1,023 green** across 28 files, including 208 isolation tests against real Postgres | — |
| Tables protected by RLS | 66 | every one |
