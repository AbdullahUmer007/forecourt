...
| | |
|---|---|
| **Current module** | M14 — Prep pipeline (`ready`, sign-off-free) · or M0 audit front end |
| **Last shipped** | M13 (3 Aug 2026) — part-exchange appraisal: damage map, recon estimate, valuation panel, offer, settlement, conversion to stock. **1,023 tests green including 208 isolation.** Also fixed `pnpm db:migrate`, which had never run. |
| **Backlog complete** | 14 of 21 modules (67%) |
