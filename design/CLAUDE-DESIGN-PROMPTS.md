# Claude Design briefs — RixDrive public dealer site
...
You are designing the **vehicle detail page** for RixDrive, a SaaS platform
...
You are designing the **stock list** for RixDrive, a SaaS platform that builds
...
website, generated by RixDrive. It does not exist yet — this is a clean sheet.
...
This is a **template**, not a one-off. Every dealer using RixDrive gets this
...
built by RixDrive. These are where the money is: every one of these is a lead
